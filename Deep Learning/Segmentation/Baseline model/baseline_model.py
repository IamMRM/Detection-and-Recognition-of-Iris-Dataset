...
class L15(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(1, 128, kernel_size=19, padding=9), nn.ReLU(inplace=True))
        ...
        self.conv15 = nn.Sequential(nn.Conv2d(64, 1, kernel_size=7, padding=3))
...
img = torch.rand((2,3,240,320)).to(device)
model = L15()
